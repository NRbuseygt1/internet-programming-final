...
<html>
    ...
    <body>
                            ...
                            <div class='left_sidebar_area'>
                                <aside class='l_widget l_categories_widget'>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href='dolarkuru.php?cat=6'>Dolar Kuru</a></li>
        ...
        ?>  <div class="col-lg-9">
                            ...
                            <form class="login_form row" action="validate.php" method="post">
                                <div class="col-lg-12 form-group">
                                    <input id="username" class="form-control" type="email" name="Email" placeholder="username@email.com" required>
                                </div>
                                <div class="col-lg-12 form-group">
                                    <input id="password" type="password" name="Password" placeholder="Password" class="form-control" required>
                                </div>
                                <div class="col-lg-12 form-group">
                                    <button "type="submit" value="Login" class="btn update_btn form-control">Login</button>
                                </div>
                            </form>
            </div>       
        </div>        
