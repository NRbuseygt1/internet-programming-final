    ...
    <body>
        ...
        <div class="tabs">
            <ul class="tab-links">
                <li class="active"><a href="#tab1">ekle</a></li>
                <li><a href="#tab2">sil</a></li>
                <li><a href="#tab3">güncelleme</a></li>
                <li><a href="http://localhost/OnlineTechStore-1/index.php">listele</a></li>
                <li><a href="#tab4">çıkış yap</a></li>
            </ul>
                ...
                <div id="tab1" class="tab active">
                    <form action="upload1.php" method="post" enctype="multipart/form-data">
                        <table>
                            ...
                            <tr><td>kategori ekle:</td>
                                <td><select name="category" id="category">
                                        <option value="Select a category">birini seç</option>
                                        <option value="Action Figures">aksiyon</option>
                                        <option value="Animals">hayvanlar</option>
                                        <option value="Cars">arabalar</option>
                                        <option value="Dolls">bebekler</option>
                                        <option value="Puzzles">yapbozlar</option>
